...
/**
 * A dynamic api that could be used by a webserver that offers CRUD for rest resources, for example like remult
 */
@Test
class DynamicApiExperiment {
    val tests = describe("dynamic api") {
        it("works") {
            // to handle the circular dependency we first specify only one side of the relation, in this example
